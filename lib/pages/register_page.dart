...
class _RegisterPage extends State<RegisterPage> {
  ...
  bool _arePasswordsMatching(
      TextEditingController password, TextEditingController rePassword) {
        ...
        child: Column(
          children: [
            ...
            FieldInput(
              ...
              title: _lableUsername,
              lableColor: _lbColorUser,
            ),
            ...
            FieldInput(
              ...
              title: _lableFullName,
              lableColor: _lbColorFullName,
            ),
            const SizedBox(height: 10.0),
            Row(
              children: [
            ...
            FieldInputPass(
              ...
              title: _lablePassword,
              lableColor: _lbColorPassword,
            ),
            const SizedBox(height: 10.0),
            Row(
              children: [
            ...
            FieldInputPass(
              ...
              title: _lableRePassword,
              lableColor: _lbColorRePassword,
            ),
                ...
                Container(
                  ...
                  child: TextButton(
                    onPressed: () async {
                      if (_validateEmail(_emailController) == false) {
                      ...
                      } else if (_isValidPhoneNumber(_phoneNumberController) ==
                          false) {
                        _updateLabelPhone(
                            'Số điện thoại không hợp lệ', Colors.red);
                        return;
                      } else if (_arePasswordsMatching(
                              _passwordController, _rePasswordController) ==
                          false) {
                        _updateLabelRePassword(
                            'Mật khẩu mới không trùng khớp', Colors.red);
                        return;
                      } else {
                        _updateLabelEmail('Nhập email', Colors.black);
                        _updateLabelPhone('Nhập số điện thoại', Colors.black);
                        _updateLabelRePassword(
                            'Nhập lại mật khẩu', Colors.black);
                        ...
                        try {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                                content: Text('Failedto register user')),
                          );
                        }
                      }
                    },
            ...
            decoration: InputDecoration(
                border: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(
                        7.0), // Set border radius for rounded corners
                    borderSide:
                        const BorderSide(color: Colors.blue) // Set border color
                    ),
                contentPadding: const EdgeInsets.symmetric(
                    vertical: 10.0, horizontal: 15.0), // Set content padding
