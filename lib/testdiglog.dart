          ...
          children: [
            ...
            Row(
              children: [
                Container(
                  margin: const EdgeInsets.only(left: 5.0),
                  child: const Text('Họ và tên', style: TextStyle(fontSize: 18.0, color: Colors.black),),
                )
              ],
            ),
            const SizedBox(height: 5.0),
            ...
            Row(
              children: [
                Container(
                  margin: const EdgeInsets.only(left: 5.0),
                  child: const Text('Email', style: TextStyle(fontSize: 18.0, color: Colors.black),),
                )
              ],
            ),
            const SizedBox(height: 5.0),
            ...
            Row(
              children: [
                Container(
                  margin: const EdgeInsets.only(left: 5.0),
                  child: const Text('Số điện thoại', style: TextStyle(fontSize: 18.0, color: Colors.black),),
                )
              ],
            ),
            const SizedBox(height: 5.0),
            ...
            Row(
              children: [
                Container(
                  margin: const EdgeInsets.only(left: 5.0),
                  child: const Text('Xác nhận mật khẩu', style: TextStyle(fontSize: 18.0, color: Colors.black),),
                )
              ],
            ),
            const SizedBox(height: 5.0),
